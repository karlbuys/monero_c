...
// void* CWLWS_Wallet_createTransaction(void* wallet_ptr, const char* dst_addr, const char* payment_id,     / like std::set I've used splitString functions and introduced a new
...
// const char* CWLWS_PendingTransaction_errorString(void* pendingTx_ptr) {
...
int CWLWS_PendingTransaction_status(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
bool CWLWS_PendingTransaction_commit(void* pendingTx_ptr, const char* filename, bool overwrite) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
/*
const char* CWLWS_PendingTransaction_commitUR(void* pendingTx_ptr, int max_fragment_length) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
uint64_t CWLWS_PendingTransaction_amount(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
    return pendingTx->amount();
    DEBUG_END()
}
uint64_t CWLWS_PendingTransaction_dust(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
    return pendingTx->dust();
    DEBUG_END()
}
uint64_t CWLWS_PendingTransaction_fee(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
    return pendingTx->fee();
    DEBUG_END()
}
const char* CWLWS_PendingTransaction_txid(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
uint64_t CWLWS_PendingTransaction_txCount(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
    return pendingTx->txCount();
    DEBUG_END()
}
const char* CWLWS_PendingTransaction_subaddrAccount(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
const char* CWLWS_PendingTransaction_subaddrIndices(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
const char* CWLWS_PendingTransaction_multisigSignData(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
void CWLWS_PendingTransaction_signMultisigTx(void* pendingTx_ptr) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
    return pendingTx->signMultisigTx();
    DEBUG_END()
}
const char* CWLWS_PendingTransaction_signersKeys(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
/*
const char* CWLWS_PendingTransaction_hex(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
const char* CWLWS_PendingTransaction_txKey(void* pendingTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::PendingTransaction *pendingTx = reinterpret_cast<Monero::PendingTransaction*>(pendingTx_ptr);
...
int CWLWS_UnsignedTransaction_status(void* unsignedTx_ptr) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return unsignedTx->status();
    DEBUG_END()
}
const char* CWLWS_UnsignedTransaction_errorString(void* unsignedTx_ptr) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
...
const char* CWLWS_UnsignedTransaction_amount(void* unsignedTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return vectorToString(unsignedTx->amount(), std::string(separator));
    DEBUG_END()
}
const char* CWLWS_UnsignedTransaction_fee(void* unsignedTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return vectorToString(unsignedTx->fee(), std::string(separator));
    DEBUG_END()
}
const char* CWLWS_UnsignedTransaction_mixin(void* unsignedTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return vectorToString(unsignedTx->mixin(), std::string(separator));
    DEBUG_END()
}
const char* CWLWS_UnsignedTransaction_confirmationMessage(void* unsignedTx_ptr) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
...
const char* CWLWS_UnsignedTransaction_paymentId(void* unsignedTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return vectorToString(unsignedTx->paymentId(), std::string(separator));
    DEBUG_END()
}
const char* CWLWS_UnsignedTransaction_recipientAddress(void* unsignedTx_ptr, const char* separator) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return vectorToString(unsignedTx->recipientAddress(), std::string(separator));
    DEBUG_END()
}
uint64_t CWLWS_UnsignedTransaction_minMixinCount(void* unsignedTx_ptr) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return unsignedTx->minMixinCount();
    DEBUG_END()
}
uint64_t CWLWS_UnsignedTransaction_txCount(void* unsignedTx_ptr) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return unsignedTx->txCount();
    DEBUG_END()
}
bool CWLWS_UnsignedTransaction_sign(void* unsignedTx_ptr, const char* signedFileName) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
    return unsignedTx->sign(std::string(signedFileName));
    DEBUG_END()
}/*
const char* CWLWS_UnsignedTransaction_signUR(void* unsignedTx_ptr, int max_fragment_length) {
    DEBUG_START()
    Monero::UnsignedTransaction *unsignedTx = reinterpret_cast<Monero::UnsignedTransaction*>(unsignedTx_ptr);
...
// TransactionInfo
int CWLWS_TransactionInfo_direction(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->direction();
    DEBUG_END()
}
bool CWLWS_TransactionInfo_isPending(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->isPending();
    DEBUG_END()
}
bool CWLWS_TransactionInfo_isFailed(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->isFailed();
    DEBUG_END()
}
bool CWLWS_TransactionInfo_isCoinbase(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->isCoinbase();
    DEBUG_END()
}
uint64_t CWLWS_TransactionInfo_amount(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->amount();
    DEBUG_END()
}
uint64_t CWLWS_TransactionInfo_fee(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->fee();
    DEBUG_END()
}
uint64_t CWLWS_TransactionInfo_blockHeight(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->blockHeight();
    DEBUG_END()
}
const char* CWLWS_TransactionInfo_description(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
const char* CWLWS_TransactionInfo_subaddrIndex(void* txInfo_ptr, const char* separator) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
uint32_t CWLWS_TransactionInfo_subaddrAccount(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->subaddrAccount();
    DEBUG_END()
}
const char* CWLWS_TransactionInfo_label(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
uint64_t CWLWS_TransactionInfo_confirmations(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->confirmations();
    DEBUG_END()
}
uint64_t CWLWS_TransactionInfo_unlockTime(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->unlockTime();
    DEBUG_END()
}
const char* CWLWS_TransactionInfo_hash(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
uint64_t CWLWS_TransactionInfo_timestamp(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
    return txInfo->timestamp();
    DEBUG_END()
}
const char* CWLWS_TransactionInfo_paymentId(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
int CWLWS_TransactionInfo_transfers_count(void* txInfo_ptr) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
uint64_t CWLWS_TransactionInfo_transfers_amount(void* txInfo_ptr, int index) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
const char* CWLWS_TransactionInfo_transfers_address(void* txInfo_ptr, int index) {
    DEBUG_START()
    Monero::TransactionInfo *txInfo = reinterpret_cast<Monero::TransactionInfo*>(txInfo_ptr);
...
// TransactionHistory
int CWLWS_TransactionHistory_count(void* txHistory_ptr) {
    DEBUG_START()
    Monero::TransactionHistory *txHistory = reinterpret_cast<Monero::TransactionHistory*>(txHistory_ptr);
    return txHistory->count();
    DEBUG_END()
}
void* CWLWS_TransactionHistory_transaction(void* txHistory_ptr, int index) {
    DEBUG_START()
    Monero::TransactionHistory *txHistory = reinterpret_cast<Monero::TransactionHistory*>(txHistory_ptr);
    return reinterpret_cast<void*>(txHistory->transaction(index));
    DEBUG_END()
}
void* CWLWS_TransactionHistory_transactionById(void* txHistory_ptr, const char* id) {
    DEBUG_START()
    Monero::TransactionHistory *txHistory = reinterpret_cast<Monero::TransactionHistory*>(txHistory_ptr);
...
void CWLWS_TransactionHistory_refresh(void* txHistory_ptr) {
    DEBUG_START()
    Monero::TransactionHistory *txHistory = reinterpret_cast<Monero::TransactionHistory*>(txHistory_ptr);
    return txHistory->refresh();
    DEBUG_END()
}
void CWLWS_TransactionHistory_setTxNote(void* txHistory_ptr, const char* txid, const char* note) {
    DEBUG_START()
    Monero::TransactionHistory *txHistory = reinterpret_cast<Monero::TransactionHistory*>(txHistory_ptr);
...
//     std::string extra;
const char* CWLWS_AddressBookRow_extra(void* addressBookRow_ptr) {
    DEBUG_START()
...
const char* CWLWS_AddressBookRow_getAddress(void* addressBookRow_ptr) {
    DEBUG_START()
    Monero::AddressBookRow *addressBookRow = reinterpret_cast<Monero::AddressBookRow*>(addressBookRow_ptr);
...
const char* CWLWS_AddressBookRow_getDescription(void* addressBookRow_ptr) {
    DEBUG_START()
    Monero::AddressBookRow *addressBookRow = reinterpret_cast<Monero::AddressBookRow*>(addressBookRow_ptr);
...
const char* CWLWS_AddressBookRow_getPaymentId(void* addressBookRow_ptr) {
    DEBUG_START()
    Monero::AddressBookRow *addressBookRow = reinterpret_cast<Monero::AddressBookRow*>(addressBookRow_ptr);
...
size_t CWLWS_AddressBookRow_getRowId(void* addressBookRow_ptr) {
    DEBUG_START()
    Monero::AddressBookRow *addressBookRow = reinterpret_cast<Monero::AddressBookRow*>(addressBookRow_ptr);
...
int CWLWS_AddressBook_getAll_size(void* addressBook_ptr) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
    return addressBook->getAll().size();
    DEBUG_END()
}
void* CWLWS_AddressBook_getAll_byIndex(void* addressBook_ptr, int index) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
bool CWLWS_AddressBook_addRow(void* addressBook_ptr, const char* dst_addr , const char* payment_id, const char* description) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
bool CWLWS_AddressBook_deleteRow(void* addressBook_ptr, size_t rowId) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
bool CWLWS_AddressBook_setDescription(void* addressBook_ptr, size_t rowId, const char* description) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
void CWLWS_AddressBook_refresh(void* addressBook_ptr) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
const char* CWLWS_AddressBook_errorString(void* addressBook_ptr) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
int CWLWS_AddressBook_errorCode(void* addressBook_ptr) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
int CWLWS_AddressBook_lookupPaymentID(void* addressBook_ptr, const char* payment_id) {
    DEBUG_START()
    Monero::AddressBook *addressBook = reinterpret_cast<Monero::AddressBook*>(addressBook_ptr);
...
/* CoinsInfo
uint64_t CWLWS_CoinsInfo_blockHeight(void* coinsInfo_ptr) {
    DEBUG_START()
...
const char* CWLWS_CoinsInfo_hash(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
size_t CWLWS_CoinsInfo_internalOutputIndex(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint64_t CWLWS_CoinsInfo_globalOutputIndex(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_spent(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_frozen(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint64_t CWLWS_CoinsInfo_spentHeight(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint64_t CWLWS_CoinsInfo_amount(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_rct(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_keyImageKnown(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
size_t CWLWS_CoinsInfo_pkIndex(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint32_t CWLWS_CoinsInfo_subaddrIndex(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint32_t CWLWS_CoinsInfo_subaddrAccount(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
const char* CWLWS_CoinsInfo_address(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
const char* CWLWS_CoinsInfo_addressLabel(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
const char* CWLWS_CoinsInfo_keyImage(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
uint64_t CWLWS_CoinsInfo_unlockTime(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_unlocked(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
const char* CWLWS_CoinsInfo_pubKey(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
bool CWLWS_CoinsInfo_coinbase(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
const char* CWLWS_CoinsInfo_description(void* coinsInfo_ptr) {
    DEBUG_START()
    Monero::CoinsInfo *coinsInfo = reinterpret_cast<Monero::CoinsInfo*>(coinsInfo_ptr);
...
int CWLWS_Coins_count(void* coins_ptr) {
    DEBUG_START()
...
void* CWLWS_Coins_coin(void* coins_ptr, int index) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
int CWLWS_Coins_getAll_size(void* coins_ptr)  {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
    return coins->getAll().size();
    DEBUG_END()
}
void* CWLWS_Coins_getAll_byIndex(void* coins_ptr, int index) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
//     virtual void refresh() = 0;
void CWLWS_Coins_refresh(void* coins_ptr) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
void CWLWS_Coins_setFrozenByPublicKey(void* coins_ptr, const char* public_key) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
void CWLWS_Coins_setFrozen(void* coins_ptr, int index) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
void CWLWS_Coins_thaw(void* coins_ptr, int index) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
void CWLWS_Coins_thawByPublicKey(void* coins_ptr, const char* public_key) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
bool CWLWS_Coins_isTransferUnlocked(void* coins_ptr, uint64_t unlockTime, uint64_t blockHeight) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
void CWLWS_Coins_setDescription(void* coins_ptr, const char* public_key, const char* description) {
    DEBUG_START()
    Monero::Coins *coins = reinterpret_cast<Monero::Coins*>(coins_ptr);
...
//     std::string extra;
const char* CWLWS_SubaddressRow_extra(void* subaddressRow_ptr) {
    DEBUG_START()
...
//     std::string getAddress() const {return m_address;}
const char* CWLWS_SubaddressRow_getAddress(void* subaddressRow_ptr) {
    DEBUG_START()
    Monero::SubaddressRow *subaddressRow = reinterpret_cast<Monero::SubaddressRow*>(subaddressRow_ptr);
...
const char* CWLWS_SubaddressRow_getLabel(void* subaddressRow_ptr) {
    DEBUG_START()
    Monero::SubaddressRow *subaddressRow = reinterpret_cast<Monero::SubaddressRow*>(subaddressRow_ptr);
...
//     std::size_t getRowId() const {return m_rowId;}
size_t CWLWS_SubaddressRow_getRowId(void* subaddressRow_ptr) {
    DEBUG_START()
    Monero::SubaddressRow *subaddressRow = reinterpret_cast<Monero::SubaddressRow*>(subaddressRow_ptr);
...
int CWLWS_Subaddress_getAll_size(void* subaddress_ptr) {
    DEBUG_START()
    Monero::Subaddress *subaddress = reinterpret_cast<Monero::Subaddress*>(subaddress_ptr);
    return subaddress->getAll().size();
    DEBUG_END()
}
void* CWLWS_Subaddress_getAll_byIndex(void* subaddress_ptr, int index) {
    DEBUG_START()
    Monero::Subaddress *subaddress = reinterpret_cast<Monero::Subaddress*>(subaddress_ptr);
...
void CWLWS_Subaddress_addRow(void* subaddress_ptr, uint32_t accountIndex, const char* label) {
    DEBUG_START()
    Monero::Subaddress *subaddress = reinterpret_cast<Monero::Subaddress*>(subaddress_ptr);
...
void CWLWS_Subaddress_setLabel(void* subaddress_ptr, uint32_t accountIndex, uint32_t addressIndex, const char* label) {
    DEBUG_START()
    Monero::Subaddress *subaddress = reinterpret_cast<Monero::Subaddress*>(subaddress_ptr);
...
void CWLWS_Subaddress_refresh(void* subaddress_ptr, uint32_t accountIndex) {
    DEBUG_START()
    Monero::Subaddress *subaddress = reinterpret_cast<Monero::Subaddress*>(subaddress_ptr);
...
//     std::string extra;
const char* CWLWS_SubaddressAccountRow_extra(void* subaddressAccountRow_ptr) {
    DEBUG_START()
...
//     std::string getAddress() const {return m_address;}
const char* CWLWS_SubaddressAccountRow_getAddress(void* subaddressAccountRow_ptr) {
    DEBUG_START()
    Monero::SubaddressAccountRow *subaddressAccountRow = reinterpret_cast<Monero::SubaddressAccountRow*>(subaddressAccountRow_ptr);
...
//     std::string getLabel() const {return m_label;}
const char* CWLWS_SubaddressAccountRow_getLabel(void* subaddressAccountRow_ptr) {
    DEBUG_START()
    Monero::SubaddressAccountRow *subaddressAccountRow = reinterpret_cast<Monero::SubaddressAccountRow*>(subaddressAccountRow_ptr);
...
const char* CWLWS_SubaddressAccountRow_getBalance(void* subaddressAccountRow_ptr) {
    DEBUG_START()
    Monero::SubaddressAccountRow *subaddressAccountRow = reinterpret_cast<Monero::SubaddressAccountRow*>(subaddressAccountRow_ptr);
...
const char* CWLWS_SubaddressAccountRow_getUnlockedBalance(void* subaddressAccountRow_ptr) {
    DEBUG_START()
    Monero::SubaddressAccountRow *subaddressAccountRow = reinterpret_cast<Monero::SubaddressAccountRow*>(subaddressAccountRow_ptr);
...
//     std::size_t getRowId() const {return m_rowId;}
size_t CWLWS_SubaddressAccountRow_getRowId(void* subaddressAccountRow_ptr) {
    DEBUG_START()
    Monero::SubaddressAccountRow *subaddressAccountRow = reinterpret_cast<Monero::SubaddressAccountRow*>(subaddressAccountRow_ptr);
...
int CWLWS_SubaddressAccount_getAll_size(void* subaddressAccount_ptr) {
    DEBUG_START()
    Monero::SubaddressAccount *subaddress = reinterpret_cast<Monero::SubaddressAccount*>(subaddressAccount_ptr);
    return subaddress->getAll().size();
    DEBUG_END()
}
void* CWLWS_SubaddressAccount_getAll_byIndex(void* subaddressAccount_ptr, int index) {
    DEBUG_START()
    Monero::SubaddressAccount *subaddress = reinterpret_cast<Monero::SubaddressAccount*>(subaddressAccount_ptr);
    return subaddress->getAll()[index];
    DEBUG_END()
...
void CWLWS_SubaddressAccount_addRow(void* subaddressAccount_ptr, const char* label) {
    DEBUG_START()
    Monero::SubaddressAccount *subaddress = reinterpret_cast<Monero::SubaddressAccount*>(subaddressAccount_ptr);
...
void CWLWS_SubaddressAccount_setLabel(void* subaddressAccount_ptr, uint32_t accountIndex, const char* label) {
    DEBUG_START()
    Monero::SubaddressAccount *subaddress = reinterpret_cast<Monero::SubaddressAccount*>(subaddressAccount_ptr);
...
//     virtual void refresh() = 0;
void CWLWS_SubaddressAccount_refresh(void* subaddressAccount_ptr) {
    DEBUG_START()
    Monero::SubaddressAccount *subaddress = reinterpret_cast<Monero::SubaddressAccount*>(subaddressAccount_ptr);
...
//     bool isMultisig;
bool CWLWS_MultisigState_isMultisig(void* multisigState_ptr) {
    DEBUG_START()
...
//     bool isReady;
bool CWLWS_MultisigState_isReady(void* multisigState_ptr) {
    DEBUG_START()
    Monero::MultisigState *multisigState = reinterpret_cast<Monero::MultisigState*>(multisigState_ptr);
...
//     uint32_t threshold;
uint32_t CWLWS_MultisigState_threshold(void* multisigState_ptr) {
    DEBUG_START()
    Monero::MultisigState *multisigState = reinterpret_cast<Monero::MultisigState*>(multisigState_ptr);
...
//     uint32_t total;
uint32_t CWLWS_MultisigState_total(void* multisigState_ptr) {
    DEBUG_START()
    Monero::MultisigState *multisigState = reinterpret_cast<Monero::MultisigState*>(multisigState_ptr);
...
bool CWLWS_DeviceProgress_progress(void* deviceProgress_ptr) {
    DEBUG_START()
...
bool CWLWS_DeviceProgress_indeterminate(void* deviceProgress_ptr) {
    DEBUG_START()
    Monero::DeviceProgress *deviceProgress = reinterpret_cast<Monero::DeviceProgress*>(deviceProgress_ptr);
...
const char* CWLWS_Wallet_seed(void* wallet_ptr, const char* seed_offset) {
    DEBUG_START()
...
const char* CWLWS_Wallet_getSeedLanguage(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setSeedLanguage(void* wallet_ptr, const char* arg) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
int CWLWS_Wallet_status(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_errorString(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setPassword(void* wallet_ptr, const char* password) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_getPassword(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setDevicePin(void* wallet_ptr, const char* pin) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setDevicePassphrase(void* wallet_ptr, const char* passphrase) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_address(void* wallet_ptr, uint64_t accountIndex, uint64_t addressIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_path(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
int CWLWS_Wallet_nettype(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->nettype();
    DEBUG_END()
}
uint8_t CWLWS_Wallet_useForkRules(void* wallet_ptr, uint8_t version, int64_t early_blocks) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->useForkRules(version, early_blocks);
    DEBUG_END()
}
const char* CWLWS_Wallet_integratedAddress(void* wallet_ptr, const char* payment_id) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_secretViewKey(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_publicViewKey(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_secretSpendKey(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_publicSpendKey(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_publicMultisigSignerKey(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_stop(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->stop();
    DEBUG_END()
...
bool CWLWS_Wallet_store(void* wallet_ptr, const char* path) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->store(std::string(path));
    DEBUG_END()
}
const char* CWLWS_Wallet_filename(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_keysFilename(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_init(void* wallet_ptr, const char* daemon_address, uint64_t upper_transaction_size_limit, const char* daemon_username, const char* daemon_password, bool use_ssl, bool lightWallet, const char* proxy_address) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_createWatchOnly(void* wallet_ptr, const char* path, const char* password, const char* language) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setRefreshFromBlockHeight(void* wallet_ptr, uint64_t refresh_from_block_height) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_getRefreshFromBlockHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setRecoveringFromSeed(void* wallet_ptr, bool recoveringFromSeed) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->setRecoveringFromSeed(recoveringFromSeed);
    DEBUG_END()
}
void CWLWS_Wallet_setRecoveringFromDevice(void* wallet_ptr, bool recoveringFromDevice) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->setRecoveringFromDevice(recoveringFromDevice);
    DEBUG_END()
}
void CWLWS_Wallet_setSubaddressLookahead(void* wallet_ptr, uint32_t major, uint32_t minor) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_connectToDaemon(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->connectToDaemon();
    DEBUG_END()
}
int CWLWS_Wallet_connected(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->connected();
    DEBUG_END()
}
void CWLWS_Wallet_setTrustedDaemon(void* wallet_ptr, bool arg) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->setTrustedDaemon(arg);
    DEBUG_END()
}
bool CWLWS_Wallet_trustedDaemon(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->trustedDaemon();
    DEBUG_END()
}
bool CWLWS_Wallet_setProxy(void* wallet_ptr, const char* address) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_balance(void* wallet_ptr, uint32_t accountIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_unlockedBalance(void* wallet_ptr, uint32_t accountIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
/*
uint64_t CWLWS_Wallet_viewOnlyBalance(void* wallet_ptr, uint32_t accountIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
// TODO
bool CWLWS_Wallet_watchOnly(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->watchOnly();
    DEBUG_END()
}
bool CWLWS_Wallet_isDeterministic(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->isDeterministic();
    DEBUG_END()
}
uint64_t CWLWS_Wallet_blockChainHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->blockChainHeight();
    DEBUG_END()
}
uint64_t CWLWS_Wallet_approximateBlockChainHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->approximateBlockChainHeight();
    DEBUG_END()
}
uint64_t CWLWS_Wallet_estimateBlockChainHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->estimateBlockChainHeight();
    DEBUG_END()
}
uint64_t CWLWS_Wallet_daemonBlockChainHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_daemonBlockChainTargetHeight(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->daemonBlockChainTargetHeight();
    DEBUG_END()
}
bool CWLWS_Wallet_synchronized(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_displayAmount(uint64_t amount) {
    DEBUG_START()
...
uint64_t CWLWS_Wallet_amountFromString(const char* amount) {
    DEBUG_START()
    return Monero::Wallet::amountFromString(amount);
    DEBUG_END()
}
//     static uint64_t amountFromDouble(double amount);
uint64_t CWLWS_Wallet_amountFromDouble(double amount) {
    DEBUG_START()
    return Monero::Wallet::amountFromDouble(amount);
    DEBUG_END()
}
//     static std::string genPaymentId();
const char* CWLWS_Wallet_genPaymentId() {
    DEBUG_START()
...
bool CWLWS_Wallet_paymentIdValid(const char* paiment_id) {
    DEBUG_START()
    return Monero::Wallet::paymentIdValid(std::string(paiment_id));
    DEBUG_END()
}
bool CWLWS_Wallet_addressValid(const char* str, int nettype) {
    DEBUG_START()
    // Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_keyValid(const char* secret_key_string, const char* address_string, bool isViewKey, int nettype) {
    DEBUG_START()
    std::string error;
    return Monero::Wallet::keyValid(std::string(secret_key_string), std::string(address_string), isViewKey, nettype, error);
    DEBUG_END()
}
const char* CWLWS_Wallet_keyValid_error(const char* secret_key_string, const char* address_string, bool isViewKey, int nettype)  {
    DEBUG_START()
    std::string str;
...
const char* CWLWS_Wallet_paymentIdFromAddress(const char* strarg, int nettype) {
    DEBUG_START()
...
uint64_t CWLWS_Wallet_maximumAllowedAmount() {
    DEBUG_START()
    return Monero::Wallet::maximumAllowedAmount();
    DEBUG_END()
}

void CWLWS_Wallet_init3(void* wallet_ptr, const char* argv0, const char* default_log_base_name, const char* log_path, bool console) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->init(argv0, default_log_base_name, log_path, console);
    DEBUG_END()
}
const char* CWLWS_Wallet_getPolyseed(void* wallet_ptr, const char* passphrase) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    std::string seed = "";
...
const char* CWLWS_Wallet_createPolyseed(const char* language) {
    DEBUG_START()
    std::string seed_words = "";
    std::string err;
    Monero::Wallet::createPolyseed(seed_words, err, std::string(language));
    std::cout << "CWLWS_Wallet_createPolyseed(language: " << language << "):" << std::endl;
...
void CWLWS_Wallet_startRefresh(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->startRefresh();
    DEBUG_END()
}
void CWLWS_Wallet_pauseRefresh(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->pauseRefresh();
    DEBUG_END()
}
bool CWLWS_Wallet_refresh(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->refresh();
    DEBUG_END()
}
void CWLWS_Wallet_refreshAsync(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->refreshAsync();
    DEBUG_END()
}
bool CWLWS_Wallet_rescanBlockchain(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->rescanBlockchain();
    DEBUG_END()
}
void CWLWS_Wallet_rescanBlockchainAsync(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->rescanBlockchainAsync();
    DEBUG_END()
}
void CWLWS_Wallet_setAutoRefreshInterval(void* wallet_ptr, int millis) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->setAutoRefreshInterval(millis);
    DEBUG_END()
}
int CWLWS_Wallet_autoRefreshInterval(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->autoRefreshInterval();
    DEBUG_END()
}
void CWLWS_Wallet_addSubaddressAccount(void* wallet_ptr, const char* label) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->addSubaddressAccount(std::string(label));
    DEBUG_END()
}
size_t CWLWS_Wallet_numSubaddressAccounts(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->numSubaddressAccounts();
    DEBUG_END()
}
size_t CWLWS_Wallet_numSubaddresses(void* wallet_ptr, uint32_t accountIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->numSubaddresses(accountIndex);
    DEBUG_END()
}
void CWLWS_Wallet_addSubaddress(void* wallet_ptr, uint32_t accountIndex, const char* label) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->addSubaddress(accountIndex, std::string(label));
    DEBUG_END()
}
const char* CWLWS_Wallet_getSubaddressLabel(void* wallet_ptr, uint32_t accountIndex, uint32_t addressIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setSubaddressLabel(void* wallet_ptr, uint32_t accountIndex, uint32_t addressIndex, const char* label) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void* CWLWS_Wallet_multisig(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_getMultisigInfo(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_makeMultisig(void* wallet_ptr, const char* info, const char* info_separator, uint32_t threshold) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_exchangeMultisigKeys(void* wallet_ptr, const char* info, const char* info_separator, bool force_update_use_with_caution) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_exportMultisigImages(void* wallet_ptr, const char* separator) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    std::string str; 
...
size_t CWLWS_Wallet_importMultisigImages(void* wallet_ptr, const char* info, const char* info_separator) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
size_t CWLWS_Wallet_hasMultisigPartialKeyImages(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void* CWLWS_Wallet_restoreMultisigTransaction(void* wallet_ptr, const char* signData) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void* CWLWS_Wallet_createTransactionMultDest(void* wallet_ptr, const char* dst_addr_list, const char* dst_addr_list_separator, const char* payment_id,
...
void* CWLWS_Wallet_createTransaction(void* wallet_ptr, const char* dst_addr, const char* payment_id,
...
void* CWLWS_Wallet_loadUnsignedTx(void* wallet_ptr, const char* fileName) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
/*
void* CWLWS_Wallet_loadUnsignedTxUR(void* wallet_ptr, const char* input) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->loadUnsignedTxUR(std::string(input));
    DEBUG_END()
}
bool CWLWS_Wallet_submitTransaction(void* wallet_ptr, const char* fileName) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->submitTransaction(std::string(fileName));
    DEBUG_END()
}
bool CWLWS_Wallet_submitTransactionUR(void* wallet_ptr, const char* input) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->submitTransactionUR(std::string(input));
    DEBUG_END()
}
bool CWLWS_Wallet_hasUnknownKeyImages(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->hasUnknownKeyImages();
    DEBUG_END()
} */
bool CWLWS_Wallet_exportKeyImages(void* wallet_ptr, const char* filename, bool all) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
/*
const char* CWLWS_Wallet_exportKeyImagesUR(void* wallet_ptr, size_t max_fragment_length, bool all) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_importKeyImages(void* wallet_ptr, const char* filename) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->importKeyImages(std::string(filename));
    DEBUG_END()
}/*
bool CWLWS_Wallet_importKeyImagesUR(void* wallet_ptr, const char* input) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->importKeyImagesUR(std::string(input));
    DEBUG_END()
}*/
bool CWLWS_Wallet_exportOutputs(void* wallet_ptr, const char* filename, bool all) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->exportOutputs(std::string(filename), all);
    DEBUG_END()
}/*
const char* CWLWS_Wallet_exportOutputsUR(void* wallet_ptr, size_t max_fragment_length, bool all) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_importOutputs(void* wallet_ptr, const char* filename) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
/*
bool CWLWS_Wallet_importOutputsUR(void* wallet_ptr, const char* input) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setupBackgroundSync(void* wallet_ptr, int background_sync_type, const char* wallet_password, const char* background_cache_password) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
int CWLWS_Wallet_getBackgroundSyncType(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_startBackgroundSync(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_stopBackgroundSync(void* wallet_ptr, const char* wallet_password) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_isBackgroundSyncing(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->hasUnknownKeyImages();
    DEBUG_END()
...
bool CWLWS_Wallet_isBackgroundWallet(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->isBackgroundWallet();
    DEBUG_END()
}
void* CWLWS_Wallet_history(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->history();
    DEBUG_END()
}
void* CWLWS_Wallet_addressBook(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void* CWLWS_Wallet_coins(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->coins();
    DEBUG_END()
...
void* CWLWS_Wallet_subaddress(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void* CWLWS_Wallet_subaddressAccount(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint32_t CWLWS_Wallet_defaultMixin(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setDefaultMixin(void* wallet_ptr, uint32_t arg) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setCacheAttribute(void* wallet_ptr, const char* key, const char* val) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_getCacheAttribute(void* wallet_ptr, const char* key) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_setUserNote(void* wallet_ptr, const char* txid, const char* note) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_getUserNote(void* wallet_ptr, const char* txid) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_getTxKey(void* wallet_ptr, const char* txid) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_signMessage(void* wallet_ptr, const char* message, const char* address) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_verifySignedMessage(void* wallet_ptr, const char* message, const char* address, const char* signature) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_rescanSpent(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_setOffline(void* wallet_ptr, bool offline) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_isOffline(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_segregatePreForkOutputs(void* wallet_ptr, bool segregate) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_segregationHeight(void* wallet_ptr, uint64_t height) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
void CWLWS_Wallet_keyReuseMitigation2(void* wallet_ptr, bool mitigation) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_lockKeysFile(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_unlockKeysFile(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_isKeysFileLocked(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
int CWLWS_Wallet_getDeviceType(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_coldKeyImageSync(void* wallet_ptr, uint64_t spent, uint64_t unspent) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
const char* CWLWS_Wallet_deviceShowAddress(void* wallet_ptr, uint32_t accountIndex, uint32_t addressIndex) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    std::string str = "";
...
bool CWLWS_Wallet_reconnectDevice(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
uint64_t CWLWS_Wallet_getBytesReceived(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return wallet->getBytesReceived();
    DEBUG_END()
}
uint64_t CWLWS_Wallet_getBytesSent(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_Wallet_getStateIsConnected() {
    DEBUG_START()
    return Monero::Wallet::getStateIsConnected();
    DEBUG_END()
}

unsigned char* CWLWS_Wallet_getSendToDevice() {
    DEBUG_START()
    return Monero::Wallet::getSendToDevice();
    DEBUG_END()
}

size_t CWLWS_Wallet_getSendToDeviceLength() {
    DEBUG_START()
    return Monero::Wallet::getSendToDeviceLength();
    DEBUG_END()
}

unsigned char* CWLWS_Wallet_getReceivedFromDevice() {
    DEBUG_START()
    return Monero::Wallet::getReceivedFromDevice();
    DEBUG_END()
}

size_t CWLWS_Wallet_getReceivedFromDeviceLength() {
    DEBUG_START()
    return Monero::Wallet::getReceivedFromDeviceLength();
    DEBUG_END()
}

bool CWLWS_Wallet_getWaitsForDeviceSend() {
    DEBUG_START()
    return Monero::Wallet::getWaitsForDeviceSend();
    DEBUG_END()
}

bool CWLWS_Wallet_getWaitsForDeviceReceive() {
    DEBUG_START()
    return Monero::Wallet::getWaitsForDeviceReceive();
    DEBUG_END()
}

void CWLWS_Wallet_setDeviceReceivedData(unsigned char* data, size_t len) {
    DEBUG_START()
    Monero::Wallet::setDeviceReceivedData(data, len);
    DEBUG_END()
}

void CWLWS_Wallet_setDeviceSendData(unsigned char* data, size_t len) {
    DEBUG_START()
    Monero::Wallet::setDeviceSendData(data, len);
    DEBUG_END()
}

void CWLWS_Wallet_setLedgerCallback(void (*sendToLedgerDevice)(unsigned char *command, unsigned int cmd_len)) {
    DEBUG_START()
    Monero::Wallet::setLedgerCallback(sendToLedgerDevice);
    DEBUG_END()
}

void* CWLWS_WalletManager_createWallet(void* wm_ptr, const char* path, const char* password, const char* language, int networkType) {
    DEBUG_START()
...
void* CWLWS_WalletManager_openWallet(void* wm_ptr, const char* path, const char* password, int networkType) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
void* CWLWS_WalletManager_recoveryWallet(void* wm_ptr, const char* path, const char* password, const char* mnemonic, int networkType, uint64_t restoreHeight, uint64_t kdfRounds, const char* seedOffset) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
void* CWLWS_WalletManager_createWalletFromKeys(void* wm_ptr, const char* path, const char* password, const char* language, int nettype, uint64_t restoreHeight, const char* addressString, const char* viewKeyString, const char* spendKeyString, uint64_t kdf_rounds) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
void* CWLWS_WalletManager_createWalletFromDevice(void* wm_ptr, const char* path, const char* password, int nettype, const char* deviceName, uint64_t restoreHeight, const char* subaddressLookahead, const char* viewKeyString, const char* spendKeyString, uint64_t kdf_rounds) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
/*
void* CWLWS_WalletManager_createDeterministicWalletFromSpendKey(void* wm_ptr, const char* path, const char* password,
...
void* CWLWS_WalletManager_createWalletFromPolyseed(void* wm_ptr, const char* path, const char* password,
...
bool CWLWS_WalletManager_closeWallet(void* wm_ptr, void* wallet_ptr, bool store) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
...
bool CWLWS_WalletManager_walletExists(void* wm_ptr, const char* path) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
bool CWLWS_WalletManager_verifyWalletPassword(void* wm_ptr, const char* keys_file_name, const char* password, bool no_spend_key, uint64_t kdf_rounds) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
int CWLWS_WalletManager_queryWalletDevice(void* wm_ptr, const char* keys_file_name, const char* password, uint64_t kdf_rounds) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
const char* CWLWS_WalletManager_findWallets(void* wm_ptr, const char* path, const char* separator) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
const char* CWLWS_WalletManager_errorString(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
void CWLWS_WalletManager_setDaemonAddress(void* wm_ptr, const char* address) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
bool CWLWS_WalletManager_setProxy(void* wm_ptr, const char* address) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
uint64_t CWLWS_WalletManager_blockchainHeight(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
uint64_t CWLWS_WalletManager_blockchainTargetHeight(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
uint64_t CWLWS_WalletManager_networkDifficulty(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
double CWLWS_WalletManager_miningHashRate(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
uint64_t CWLWS_WalletManager_blockTarget(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
bool CWLWS_WalletManager_isMining(void* wm_ptr) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
    return wm->isMining();
    DEBUG_END()
...
bool CWLWS_WalletManager_startMining(void* wm_ptr, const char* address, uint32_t threads, bool backgroundMining, bool ignoreBattery) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
bool CWLWS_WalletManager_stopMining(void* wm_ptr, const char* address) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
const char* CWLWS_WalletManager_resolveOpenAlias(void* wm_ptr, const char* address, bool dnssec_valid) {
    DEBUG_START()
    Monero::WalletManager *wm = reinterpret_cast<Monero::WalletManager*>(wm_ptr);
...
void* CWLWS_WalletManagerFactory_getWalletManager() {
    DEBUG_START()
...
void CWLWS_WalletManagerFactory_setLogLevel(int level) {
    DEBUG_START()
    return Monero::WalletManagerFactory::setLogLevel(level);
    DEBUG_END()
}

void CWLWS_WalletManagerFactory_setLogCategories(const char* categories) {
    DEBUG_START()
...
bool CWLWS_DEBUG_test1(bool x) {
    return x;
}

int CWLWS_DEBUG_test2(int x) {
    return x;
}

uint64_t CWLWS_DEBUG_test3(uint64_t x) {
    return x;
}

void* CWLWS_DEBUG_test4(uint64_t x) {
    int *y = new int(x);
    return reinterpret_cast<void*>(y);
}

const char* CWLWS_DEBUG_test5() {
    const char *text = "This is a const char* text"; 
    return text;
}

const char* CWLWS_DEBUG_test5_std() {
    std::string text("This is a std::string text");
    const char *text2 = "This is a text"; 
    return text2;
}

bool CWLWS_DEBUG_isPointerNull(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    return (wallet != NULL);
    DEBUG_END()
...
struct CWLWS_cw_WalletListener;
struct CWLWS_cw_WalletListener : Monero::WalletListener
{
    uint64_t m_height;
    bool m_need_to_refresh;
    bool m_new_transaction;

    CWLWS_cw_WalletListener()
    {
        m_height = 0;
...
void* CWLWS_cw_getWalletListener(void* wallet_ptr) {
    DEBUG_START()
    Monero::Wallet *wallet = reinterpret_cast<Monero::Wallet*>(wallet_ptr);
    CWLWS_cw_WalletListener *listener = new CWLWS_cw_WalletListener();
    wallet->setListener(listener);
    return reinterpret_cast<void*>(listener);
    DEBUG_END()
}

void CWLWS_cw_WalletListener_resetNeedToRefresh(void* cw_walletListener_ptr) {
    DEBUG_START()
    CWLWS_cw_WalletListener *listener = reinterpret_cast<CWLWS_cw_WalletListener*>(cw_walletListener_ptr);
    listener->cw_resetNeedToRefresh();
    DEBUG_END()
}

bool CWLWS_cw_WalletListener_isNeedToRefresh(void* cw_walletListener_ptr) {
    DEBUG_START()
    CWLWS_cw_WalletListener *listener = reinterpret_cast<CWLWS_cw_WalletListener*>(cw_walletListener_ptr);
...
bool CWLWS_cw_WalletListener_isNewTransactionExist(void* cw_walletListener_ptr) {
    DEBUG_START()
    CWLWS_cw_WalletListener *listener = reinterpret_cast<CWLWS_cw_WalletListener*>(cw_walletListener_ptr);
    return listener->cw_isNeedToRefresh();
    DEBUG_END()
...
void CWLWS_cw_WalletListener_resetIsNewTransactionExist(void* cw_walletListener_ptr) {
    DEBUG_START()
    CWLWS_cw_WalletListener *listener = reinterpret_cast<CWLWS_cw_WalletListener*>(cw_walletListener_ptr);
...
uint64_t CWLWS_cw_WalletListener_height(void* cw_walletListener_ptr) {
    DEBUG_START()
    CWLWS_cw_WalletListener *listener = reinterpret_cast<CWLWS_cw_WalletListener*>(cw_walletListener_ptr);
    return listener->cw_isNeedToRefresh();
    DEBUG_END()
...
const char* CWLWS_checksum_wallet2_api_c_h() {
    return CWLWS_wallet2_api_c_h_sha256;
}
const char* CWLWS_checksum_wallet2_api_c_cpp() {
    return CWLWS_wallet2_api_c_cpp_sha256;
}
const char* CWLWS_checksum_wallet2_api_c_exp() {
    return CWLWS_wallet2_api_c_exp_sha256;
}
// i hate windows

void CWLWS_free(void* ptr) {
    free(ptr);
}
